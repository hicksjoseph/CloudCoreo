---
title: All authenticated AWS users can change bucket permissions
tags:
keywords: ""
last_updated: "September 17, 2016"
summary:  Bucket has permissions which let any AWS authenticated user modify the permissions.
published: true
sidebar: mydoc_sidebar
permalink: mydoc_s3-authenticatedusers-write-acp.html
folder: mydoc
toc: false
---
...
### Suggested Action  
Remove the entry from the bucket permissions that allows Any Authenticated AWS User to edit permissions Use the following steps to remove any public access that you have granted to your bucket via an Access Control List (ACL): [https://aws.amazon.com/articles/5050](https://aws.amazon.com/articles/5050)  
